...
DIM_USER_PROFILE = 10
DIM_DENSE_FEATURE = 3
#PYTHON_PATH = "/home/yaoxuefeng/whls/paddle_release_home/python/bin/python" # this is mine change your own python path
PYTHON_PATH = "python"
def train():
    args = parse_args()
    ...
    #self define how to process generated training insatnces in map_reader_mmh.py
    pipe_command = PYTHON_PATH + "  map_reader_mmh.py %d" % args.sparse_feature_dim
    dataset.set_pipe_command(pipe_command)
    dataset.set_batch_size(args.batch_size)
    #set thread num not larger than the length of filelist for muli-thread loading data
    thread_num = 12
